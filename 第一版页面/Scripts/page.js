...
; (function ($, window, document) {
    ...
    $.fn.extend({
        paging: function (options) {
            ...
            var defaults = {
                pagesize:10, //每页显示数量,
                allcount:10, //数据总条数
                total: 20,   //全部页数,  根据pagesize,allcount计算
                showPage: 9,  //显示的页数
                height: 30,    //高
                width: 8,      //宽
                ...
                currentPage: 1,             //当前页
                centerBgColor: "#ffffff",   //中间页数按钮的底色
                centerHoverBgColor: "",    //中间鼠标悬浮的的底色
                otherBgColor: "#ffffff",    //两边按钮的底色
                otherHoverBgColor: "",     //两边鼠标悬浮的背景颜色
                jumpBgColor: "#ffffff",           //跳转a标签按钮的背景色
                jumpHoverBgColor: "",       //跳转a标签背景的悬浮背景色
                currentBgColor: "#49CBCD",      //当前选中页的底色
                centerBorder: "1px solid #D6DBE9",           //中间按钮的边框
                otherBorder: "1px solid #D6DBE9",          //两边按钮的边框
                centerHoverBorder: "",               //中间按钮悬浮边框
                otherHoverBorder: "",                 //两边按钮悬浮边框
                jumpBorder: "1px solid #D6DBE9",            //跳转内标签的边框
                jumpHoverBorder: "",                   //跳转内标签的悬浮边框
                currentBorder: "",          //当前选中页的边框
                showJump: false,               //是否显示跳转功能
                transition: "initial",       //效果延迟all .2s
                gapWidth: 2,      //间隙宽度
                cormer: 0,   //按钮的边角曲度
                ...
                url: "",               //需要提交的目标控制器，如"/Home/List/"或"/Home/List?name='张三'&password='123456'"
            ...
            var tmpcount = opts.allcount / opts.pagesize;

            if (opts.allcount % opts.pagesize > 0)
                tmpcount++;
                    ...
                    $(element).click(function () {
                        ...
                        if (!opts.animation) {         //非滚动方式的显示
                            ...
                            if (clickPage != opts.currentPage) {   //避免第一次加载时就请求
                                ...
                                try {
                                    eval(opts.callFn + '(' + opts.currentPage + ');');
    ...
    //$(".page_div3").css("width","100%").parent().css("width", "700px");
